...
%             and    2) a string representing the id of the compartmentType to be found
%
%             and returns 
%               the compartmentType structure with the matching id 
%               or an empty structure if no such compartmentType exists
%               
%       compartmentType = Model_getCompartmentTypeById(SBMLModel, 'id')

%  Filename    :   Model_getCompartmentTypeById.m
%  Description :
