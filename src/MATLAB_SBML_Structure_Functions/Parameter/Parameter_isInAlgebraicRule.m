...
% Parameter_isInAlgebraicRule takes an SBMLParameter structure and an array of SBMLRule structures
% and returns
%             0 if the Parameter is not in an algebraic rule
%             [n1, n2] if the Parameter occurs as within a rule
%     where n1, n2 refers to the index of the matched rule in the array

%  Filename    :   Parameter_isInAlgebraicRule.m
%  Description :
%  Author(s)   :   SBML Development Group <sbml-team@caltech.edu>
%  $Id: Parameter_isInAlgebraicRule.m 13259 2011-03-21 05:40:36Z mhucka $
%  $Source v $
%
%<!---------------------------------------------------------------------------
