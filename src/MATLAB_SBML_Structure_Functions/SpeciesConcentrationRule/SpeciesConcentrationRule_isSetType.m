function value = SpeciesConcentrationRule_isSetType(SBMLSpeciesConcentrationRule)
%
% SpeciesConcentrationRule_isSetType
...
%  Filename    :   SpeciesConcentrationRule_isSetType.m
%  Description :
