...
%           an MATLAB_SBML CompartmentType structure of the appropriate
%           level and version
%
% The fields present in MATLAB_SBML CompartmentType structure of the appropriate
% level and version can be found using getCompartmentTypeFieldnames(level, version)

%  Filename    :   getCompartmentTypeDefaultValues.m
%  Description :
