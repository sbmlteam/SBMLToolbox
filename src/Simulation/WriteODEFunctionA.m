...
fileNameEvent = strcat(Name, '_events.m');
NameEvent = strcat(Name, '_events');
%--------------------------------------------------------------------
% open the file for writing

fileID_event = fopen(fileNameEvent, 'w');

% write the function declaration
fprintf(fileID_event,  'function [value,isterminal,direction] = %s(time, y)\n', NameEvent);
