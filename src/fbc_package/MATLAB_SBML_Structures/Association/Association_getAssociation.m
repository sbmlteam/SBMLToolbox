function association = Association_getAssociation(SBMLAssociation)
% association = Association_getAssociation(SBMLAssociation)
%
% Takes
%
...
if isfield(SBMLAssociation, 'fbc_association')
	association = SBMLAssociation.fbc_association;
else
