function value = Association_isSetAssociation(SBMLAssociation)
% association = Association_isSetAssociation(SBMLAssociation)
%
% Takes
%
...
%
% 1. value = 
%  - 1 if the fbc_association attribute is set
%  - 0 otherwise
%
...
if isfield(SBMLAssociation, 'fbc_association')
	value = ~isempty(SBMLAssociation.fbc_association);
else
