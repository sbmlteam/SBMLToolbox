function SBMLAssociation = Association_unsetMetaid(SBMLAssociation)
% SBMLAssociation = Association_unsetMetaid(SBMLAssociation)
%
% Takes
%
...
% Returns
%
% 1. the SBML FBC Association structure with the metaid attribute unset
%
