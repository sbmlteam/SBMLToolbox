function geneProduct = FBCModel_getListOfGeneProducts(SBMLFBCModel)
% geneProduct = FBCModel_getListOfGeneProducts(SBMLFBCModel)
%
% Takes
%
...
% Returns
%
% 1. an array of the geneProduct structures
%
