function num = FBCModel_getNumGeneProducts(SBMLFBCModel)
% num = FBCModel_getNumGeneProducts(SBMLFBCModel)
%
% Takes
%
...
% Returns
%
% 1. the number of SBML GeneProduct structures present in the FBCModel
%
...
if isfield(SBMLFBCModel, 'fbc_geneProduct')
	num = length(SBMLFBCModel.fbc_geneProduct);
else
