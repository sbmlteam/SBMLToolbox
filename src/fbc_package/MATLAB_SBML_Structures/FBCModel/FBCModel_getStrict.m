function strict = FBCModel_getStrict(SBMLFBCModel)
% strict = FBCModel_getStrict(SBMLFBCModel)
%
% Takes
%
...
% Returns
%
% 1. the value of the fbc_strict attribute
%
...
if isfield(SBMLFBCModel, 'fbc_strict')
	strict = SBMLFBCModel.fbc_strict;
else
