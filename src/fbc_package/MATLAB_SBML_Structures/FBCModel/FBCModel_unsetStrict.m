function SBMLFBCModel = FBCModel_unsetStrict(SBMLFBCModel)
% SBMLFBCModel = FBCModel_unsetStrict(SBMLFBCModel)
%
% Takes
%
...
% Returns
%
% 1. the SBML FBC FBCModel structure with the fbc_strict attribute unset
%
