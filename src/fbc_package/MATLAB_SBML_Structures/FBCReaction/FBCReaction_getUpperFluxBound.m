function upperFluxBound = FBCReaction_getUpperFluxBound(SBMLFBCReaction)
% upperFluxBound = FBCReaction_getUpperFluxBound(SBMLFBCReaction)
%
% Takes
%
...
% Returns
%
% 1. the value of the fbc_upperFluxBound attribute
%
...
if isfield(SBMLFBCReaction, 'fbc_upperFluxBound')
	upperFluxBound = SBMLFBCReaction.fbc_upperFluxBound;
else
