function value = FBCReaction_isSetUpperFluxBound(SBMLFBCReaction)
% upperFluxBound = FBCReaction_isSetUpperFluxBound(SBMLFBCReaction)
%
% Takes
%
...
%
% 1. value = 
%  - 1 if the fbc_upperFluxBound attribute is set
%  - 0 otherwise
%
...
if isfield(SBMLFBCReaction, 'fbc_upperFluxBound')
	value = ~isempty(SBMLFBCReaction.fbc_upperFluxBound);
else
