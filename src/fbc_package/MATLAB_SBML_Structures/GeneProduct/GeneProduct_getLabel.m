function label = GeneProduct_getLabel(SBMLGeneProduct)
% label = GeneProduct_getLabel(SBMLGeneProduct)
%
% Takes
%
...
% Returns
%
% 1. the value of the fbc_label attribute
%
...
if isfield(SBMLGeneProduct, 'fbc_label')
	label = SBMLGeneProduct.fbc_label;
else
