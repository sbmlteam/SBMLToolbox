function value = GeneProduct_isSetLabel(SBMLGeneProduct)
% label = GeneProduct_isSetLabel(SBMLGeneProduct)
%
% Takes
%
...
%
% 1. value = 
%  - 1 if the fbc_label attribute is set
%  - 0 otherwise
%
...
if isfield(SBMLGeneProduct, 'fbc_label')
	value = ~isempty(SBMLGeneProduct.fbc_label);
else
