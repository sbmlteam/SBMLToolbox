function value = GeneProductAssociation_isSetAssociation(SBMLGeneProductAssociation)
% association = GeneProductAssociation_isSetAssociation(SBMLGeneProductAssociation)
%
% Takes
%
