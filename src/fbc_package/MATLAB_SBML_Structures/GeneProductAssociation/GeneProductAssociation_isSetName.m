function value = GeneProductAssociation_isSetName(SBMLGeneProductAssociation)
% name = GeneProductAssociation_isSetName(SBMLGeneProductAssociation)
%
% Takes
%
...
if isfield(SBMLGeneProductAssociation, 'fbc_name')
	value = ~isempty(SBMLGeneProductAssociation.fbc_name);
else
