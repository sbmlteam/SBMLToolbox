function [fail, num, message] = testFBCReaction()
%
% testFBCReaction
%
%    returns
...
disp('Testing FBCReaction');

disp('Testing L1V1');
obj = FBCReaction_create(1, 1);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L1V2');
obj = FBCReaction_create(1, 2);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L2V1');
obj = FBCReaction_create(2, 1);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L2V2');
obj = FBCReaction_create(2, 2);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L2V3');
obj = FBCReaction_create(2, 3);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L2V4');
obj = FBCReaction_create(2, 4);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);

disp('Testing L3V1');
obj = FBCReaction_create(3, 1);
attributes = {};
[fail, num, message] = testObject(obj, attributes, 'FBCReaction', fail, num, message);
