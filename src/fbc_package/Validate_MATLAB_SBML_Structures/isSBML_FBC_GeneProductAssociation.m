function [valid, message] = isSBML_FBC_GeneProductAssociation(varargin)
% [valid, message] = isSBML_FBC_GeneProductAssociation(SBMLFBCGeneProductAssociation, level, version, pkgVersion)
%
% Takes
%
% 1. SBMLStructure, an SBML FBC GeneProductAssociation structure
...
%        a MATLAB_SBML FBC GeneProductAssociation structure of the appropriate
%        level, version and FBC version
%   - 0, otherwise
% 2. a message explaining any failure
%
% *NOTE:* The fields present in a MATLAB_SBML FBC GeneProductAssociation structure of the appropriate
% level and version can be found using getGeneProductAssociationFieldnames(level, version, pkgVersion)
%
...
% check the typecode
typecode = 'SBML_FBC_GENE_PRODUCT_ASSOCIATION';
...
[SBMLfieldnames, numFields] = getFieldnames('SBML_FBC_GENE_PRODUCT_ASSOCIATION', level, ...
                                              version, pkgVersion);
...
% report failure
if (valid == 0)
	message = sprintf('Invalid FBC GeneProductAssociation\n%s\n', message);
end;
