function fail = TestIsSBML_FBC_GeneProduct
...
s_l3v1_bad = struct('typecode', {'SBML_FBC_GENE_PRODUCT'}, 'metaid', {''}, ...
...
s_l3v1_v2 = struct('typecode', {'SBML_FBC_GENE_PRODUCT'}, 'metaid', {''}, ...
  'notes', {''}, 'annotation', {''}, 'sboTerm', {''}, 'fbc_id', {''}, ...
    'fbc_name', {''}, 'fbc_label', {''}, 'fbc_associatedSpecies', {''}, ...
    'level', {3}, 'version', {1}, 'fbc_version', {2});

fail = TestFunction('isSBML_FBC_GeneProduct', 4, 1, s_l3v1_v2, 3, 1, 1, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 4, 1, s_l3v1_v2, 3, 1, 2, 1);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 3, 1, s_l3v1_v2, 3, 1, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 3, 1, s_l3v1_v2, 2, 4, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 2, 1, s_l3v1_v2, 3, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 2, 1, s_l3v1_v2, 2, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 1, 1, s_l3v1_v2, 0);
...
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 4, 1, s_l3v1_bad, 3, 1, 1, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 4, 1, s_l3v1_bad, 3, 1, 2, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 3, 1, s_l3v1_bad, 3, 1, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 3, 1, s_l3v1_bad, 2, 4, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 2, 1, s_l3v1_bad, 3, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 2, 1, s_l3v1_bad, 2, 0);
fail = fail + TestFunction('isSBML_FBC_GeneProduct', 1, 1, s_l3v1_bad, 0);
