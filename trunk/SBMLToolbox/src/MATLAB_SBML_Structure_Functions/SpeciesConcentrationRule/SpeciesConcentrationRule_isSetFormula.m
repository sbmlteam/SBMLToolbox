function value = SpeciesConcentrationRule_isSetFormula(SBMLSpeciesConcentrationRule)
%
% SpeciesConcentrationRule_isSetFormula
...
%  Filename    :   SpeciesConcentrationRule_isSetFormula.m
%  Description :
