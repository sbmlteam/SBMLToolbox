...
%
% getLocalParameterDefaultValues
%    takes an SBML level
%    and   an SBML version
%
%    returns
%      1) the default values for the structure represents
%           an MATLAB_SBML LocalParameter structure of the appropriate
%           level and version
%
% The fields present in MATLAB_SBML LocalParameter structure of the appropriate
% level and version can be found using getLocalParameterFieldnames(level, version)

%  Filename    :   getLocalParameterDefaultValues.m
%  Description :
