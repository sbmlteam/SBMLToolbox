...
%
% getStoichiometryMathDefaultValues
%    takes an SBML level
%    and   an SBML version
%
%    returns
...
%           level and version
%
% The fields present in MATLAB_SBML StoichiometryMath structure of the appropriate
% level and version can be found using getStoichiometryMathFieldnames(level, version)

%  Filename    :   getStoichiometryMathDefaultValues.m
%  Description :
