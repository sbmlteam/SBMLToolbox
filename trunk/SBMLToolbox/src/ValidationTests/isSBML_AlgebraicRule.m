function y = isSBML_AlgebraicRule(SBMLStructure, Level)
% isSBML_AlgebraicRule(SBMLStructure, Level) checks that SBMLStructure represents a algebraic rule 
...
% fields and the typecode is  "SBML_ALGEBRAIC_RULE"
% 
