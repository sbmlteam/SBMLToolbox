...
3. Edit inno-script to latest version

4. Running CreateRelease and then the inno script creates 
the windows installer

5. Running CreateSRCRelease creates the directory structure
